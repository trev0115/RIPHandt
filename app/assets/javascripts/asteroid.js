...
gameState.prototype = {
    ...
    preload: function () {
        ...
        game.load.spritesheet('ship', 'projects/RIPHandt/app/assets/images/spaceShip.png', 110, 170);
		game.load.spritesheet('laser', 'lazer.png');
		game.load.spritesheet('asteroid', 'asteroid.png', 64 , 64);
    },
